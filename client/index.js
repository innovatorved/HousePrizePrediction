...
function onClickedEstimatePrice() {
  ...
  var url = "http://localhost:5001/api/predict_home_price"; // Use this if  you are using nginx. i.e tutorial 8 and onwards
...
function onPageLoad() {
  ...
  let url = "http://localhost:5001/api/get_location_names";
